...
Запускается проект модулем main, в нем вызывается user_interact(), в котором вызывается интерфейс пользователя, позволяющий задействовать все функциональности
